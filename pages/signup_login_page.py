...
class SignupLoginPage(BasePage):
    ...
    LOGIN_EMAIL_ADDRESS_FIELD = ('xpath', '[data-qa="login-email"]')
    LOGIN_PASSWORD_FIELD = ('xpath', '[data-qa="login-password"]')
    LOGIN_BTTN = ('xpath', '[data-qa="login-button"]')
    LOGIN_INFO_LABEL = ('css selector', '.login-form h2')
    SIGNUP_NAME_FIELD = ('xpath', '[data-qa="signup-name"]')
    SIGNUP_EMAIL_ADDRESS_FIELD = ('xpath', '[data-qa="signup-email"]')
    SIGNUP_BTTN = ('xpath', '[data-qa="signup-button"]')
    ...
    def enter_signup_name(self, login):
        self.wait.until(EC.element_to_be_clickable(self.SIGNUP_NAME_FIELD)).send_keys(login)

    @allure.step("Enter email for signup")
    def enter_signup_email(self, password):
        self.wait.until(EC.element_to_be_clickable(self.SIGNUP_EMAIL_ADDRESS_FIELD)).send_keys(password)
